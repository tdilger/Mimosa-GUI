...
export const LocationView: Component = () => {
     ...
     */
    return (
        <div id="locationView" class="z-0 relative text-center m-auto overflow-hidden outline-dashed">
            <h2 class="text-3xl py-5">{ current_location().name }</h2>
            <div id="locationDisplay" class="relative m-auto outline-dashed" 
            style={{'width': `${ viewWidth() }em`, 'height': `${ viewHeight() }em`, 'aspect-ratio': `${ current_location().width } / ${ current_location().height }` }}>
